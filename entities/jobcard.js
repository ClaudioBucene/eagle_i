...
var jobcardSchema=new mongoose.Schema({
	...
	jobcard_credelecinfo:[{jobcard_currentkwh:String, jobcard_kwhafter:String, jobcard_payamount:String, jobcard_amount:String, jobcard_amountadded:String, jobcard_transactionr:String, jobcard_credelecnr:String, jobcard_itemphoto:String,}],
